					...
					>
						...
						<div className="flex flex-col gap-4 sm:flex-row">
							<div className="w-full flex flex-col gap-1 justify-center">
								...
								<div className="w-full relative border border-borderColor rounded-md bg-borderColor text-heading h-10">
									...
									<User className="size-5 flex items-center absolute right-4 top-1/2 -translate-y-1/2 z-0 " />
								</div>
							</div>
						...
						<div className="w-full flex flex-col gap-1 justify-center">
							...
							<div className="w-full relative border border-borderColor rounded-md bg-borderColor text-heading h-10">
								...
								<Lock className="size-5 flex items-center absolute right-4 top-1/2 -translate-y-1/2 z-0 " />
							</div>
						</div>
