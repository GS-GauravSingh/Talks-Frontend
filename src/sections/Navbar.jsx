...
function Navbar() {
    ...
    return (
        <div
            className={`${commonStyles.borderRight} ${commonStyles.background} h-full px-2 py-2 space-y-10 flex flex-col items-center `}
        >
            {/* Chat Logo */}
            <span className="flex items-center justify-center bg-darkCyan text-white p-2 rounded-md cursor-default mt-4" title="Talks">
