...
function ChatList() {
    ...
    return (
        <div className={`h-full w-1/4 cursor-default flex flex-col`}>
            {/* Header */}
            <div
                className={`${commonStyles.borderBottom} px-2 py-6 flex flex-row items-center justify-between`}
            >
            ...
            <div className={`px-2 py-4 `}>
                <div
                    className={`${commonStyles.inputBackground} w-full h-10 rounded-full relative group`}
                >
                    <input
                        type="text"
                        name=""
